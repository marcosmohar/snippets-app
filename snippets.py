...
def get(name, filename):
	""" Retrieve a stored snippet"""
	logging.info("Searching for {!r} snippet in {!r}".format(name, filename))
	...
	if snippet == None:
		return "The snippet does not exist"			
	return name, snippet		
...
def main():
	...
	if command == "put":
		...
		try:
			...
			print "Retrieved {!r} snippet from {!r}".format(snippet,name)
		except:
			print "There's not such snippet stored here"
